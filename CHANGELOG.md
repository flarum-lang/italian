...
* Rimosse le traduzioni dei core Flarum obsolete (è supportata la versione `{versione}` o successiva).
* Rimosse le traduzioni di convalida obsolete (è supportata la versione `{versione}` o successiva).
...
**Rimosse traduzioni estensioni obsolete**:
...
**Rimosso il supporto per le estensioni obsolete**:
...
* [`askvortsov/flarum-trust-levels`](https://github.com/askvortsov1/flarum-trust-levels)
...
* `justoverclock-guest-engagement`
...
* [`nearata/flarum-ext-no-self-likes`](https://github.com/Nearata/flarum-ext-no-self-likes)
...
Cambiamenti: [1.19.3...2.0.0](https://github.com/flarum-lang/italian/compare/1.19.3...2.0.0).
...
Cambiamenti: [1.19.2...1.19.3](https://github.com/flarum-lang/italian/compare/1.19.2...1.19.3).
